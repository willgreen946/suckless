...
static const char *icecat[] = {"icecat", NULL}; //To launcher icecats with my icecat launcher
...
/*Shorter tags key bindings*/static Key keys[] = {
	...
	{ MODKEY|ShiftMask, 		XK_space,  spawn,	   {.v = firefox } }, //Should open firefox
	{ MODKEY,			XK_i,	   spawn,	   {.v = icecat } }, //To open GNU icecats with my icecats launcher
